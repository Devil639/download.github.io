        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-3 col-sm-2 align-self-center text-center text-md-right">
                <?php if(get_theme_mod('hotel_booking_lite_phone') != ''){ ?>
                    <span><i class="fas fa-phone mr-3"></i><a href="tel:<?php echo esc_html(get_theme_mod('hotel_booking_lite_phone','')); ?>"><?php echo esc_html(get_theme_mod('hotel_booking_lite_phone','')); ?></a></span>
                <?php }?>
            </div>
