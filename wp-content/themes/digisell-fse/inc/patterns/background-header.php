 ...
 */
return array(
	'title'      => esc_html__( 'Background Header', 'digisell-fse' ),
	'categories' => array( 'digisell-fse', 'Background header' ),
	'content'    => '<!-- wp:group {"style":{"spacing":{"blockGap":"0","padding":{"bottom":"0","top":"0","left":"var:preset|spacing|40","right":"var:preset|spacing|40"}},"border":{"width":"0px","style":"none","radius":"0px"}},"className":"header-Fixed","layout":{"type":"constrained"}} -->
<div class="wp-block-group header-Fixed" style="border-style:none;border-width:0px;border-radius:0px;padding-top:0;padding-right:var(--wp--preset--spacing--40);padding-bottom:0;padding-left:var(--wp--preset--spacing--40)"><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"var:preset|spacing|20","bottom":"0","left":"var:preset|spacing|20"},"blockGap":"0"}},"backgroundColor":"cyan-bluish-gray","className":"Hdr-Top-Strip","layout":{"type":"constrained","contentSize":"1200px"}} -->
<div class="wp-block-group Hdr-Top-Strip has-cyan-bluish-gray-background-color has-background" style="padding-top:0;padding-right:var(--wp--preset--spacing--20);padding-bottom:0;padding-left:var(--wp--preset--spacing--20)"><!-- wp:group {"style":{"spacing":{"padding":{"top":"0","right":"0","left":"0","bottom":"0"},"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
...
<div class="wp-block-group my-site-logo"><!-- wp:image {"id":916,"sizeSlug":"full","linkDestination":"none"} -->
...
<div class="wp-block-group"><!-- wp:navigation {"ref":42,"icon":"menu","className":"site-navigation","style":{"spacing":{"blockGap":"var:preset|spacing|40"}}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
