...
$wp_customize->add_section( 'section_home_fitnesscat',
	array(
		'title'      => __( 'Category List', 'kuza-classic-blog' ),
		'capability' => 'edit_theme_options',
		'panel'      => 'home_page_panel',
		'active_callback' => 'kuza_classic_blog_fitnesscat_design_enable',
		)
);
...
$wp_customize->add_control( new Kuza_Classic_Blog_Switch_Control( $wp_customize, 'theme_options[disable_fitnesscat_section]',
    array(
		'label' 			=> __('Enable/Disable Category List Section', 'kuza-classic-blog'),
...
$wp_customize->add_control('theme_options[fitnesscat_title]', 
	array(
	'label'       => __('Section Title', 'kuza-classic-blog'),
	'section'     => 'section_home_fitnesscat',   
	'settings'    => 'theme_options[fitnesscat_title]',
	'active_callback' => 'kuza_classic_blog_fitnesscat_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control('theme_options[fitnesscat_subtitle]', 
	array(
	'label'       => __('Section Sub Title', 'kuza-classic-blog'),
	'section'     => 'section_home_fitnesscat',   
...
$wp_customize->add_setting( 'theme_options[fitnesscat_category]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'kuza_classic_blog_sanitize_category_list',
	)
);
$wp_customize->add_control(
	new Kuza_Classic_Blog_Dropdown_Multiple_Chooser( $wp_customize, 'theme_options[fitnesscat_category]',
		array(
		'label'    => __( 'Select Categories', 'kuza-classic-blog' ),
		'description' => __('Press Ctrl and select categories for multiple categories', 'kuza-classic-blog'),
		'section'  => 'section_home_fitnesscat',
		'settings' => 'theme_options[fitnesscat_category]',
		'type'           	=> 'dropdown_multiple_chooser',
		'choices'  => kuza_classic_blog_category_choices(),
		'active_callback' => 'kuza_classic_blog_fitnesscat_active',		
		)
	)
);
