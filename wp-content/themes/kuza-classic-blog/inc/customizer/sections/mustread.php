...
$wp_customize->add_section( 'section_home_mustread',
	array(
		'title'      => __( 'Must Read Posts', 'kuza-classic-blog' ),
		'capability' => 'edit_theme_options',
		'panel'      => 'home_page_panel',
		'active_callback' => 'kuza_classic_blog_mustread_design_enable',
		)
);
...
$wp_customize->add_control( new Kuza_Classic_Blog_Switch_Control( $wp_customize, 'theme_options[disable_mustread_section]',
    array(
		'label' 			=> __('Enable/Disable Must Read Section', 'kuza-classic-blog'),
...
$wp_customize->add_control('theme_options[mustread_title]', 
	...
	'active_callback' => 'kuza_classic_blog_mustread_active',		
	'type'        => 'text'
	)
);
...
$wp_customize->add_control(
	new Kuza_Classic_Blog_Dropdown_Taxonomies_Control( $wp_customize, 'theme_options[mustread_category]',
		array(
		'label'    => __( 'Select Category', 'kuza-classic-blog' ),
		'section'  => 'section_home_mustread',
