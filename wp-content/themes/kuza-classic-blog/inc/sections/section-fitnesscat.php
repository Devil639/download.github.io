<?php
    ...
    $fitnesscat_title    = kuza_classic_blog_get_option( 'fitnesscat_title' );
    $fitnesscat_subtitle    = kuza_classic_blog_get_option( 'fitnesscat_subtitle' );
    $enable_small_category     = kuza_classic_blog_get_option( 'fitnesscat_small_category_enable' );
    $enable_category     = kuza_classic_blog_get_option( 'fitnesscat_category_enable' );
    $view_more_txt     = kuza_classic_blog_get_option( 'fitnesscat_see_all_txt' );
    $enable_content     = kuza_classic_blog_get_option( 'fitnesscat_content_enable' );
    $enable_author     = kuza_classic_blog_get_option( 'fitnesscat_author_enable' );
    $enable_posted_on     = kuza_classic_blog_get_option( 'fitnesscat_posted_on_enable' );
    $number_of_fitnesscat_items  = kuza_classic_blog_get_option( 'number_of_fitnesscat_items' );
    $fitnesscat_category = kuza_classic_blog_get_option( 'fitnesscat_category' );
    $fitnesscat_header_font_size =kuza_classic_blog_get_option( 'fitnesscat_section_header_font_size');
    $fitnesscat_subtitle_font_size =kuza_classic_blog_get_option( 'fitnesscat_subtitle_font_size');
    $header_font_size = kuza_classic_blog_get_option( 'fitnesscat_font_size');
    $fitnesscat_layout = kuza_classic_blog_get_option('fitnesscat_layout_option');
    $excerpt_length =kuza_classic_blog_get_option( 'fitnesscat_excerpt_length');
    $home_layout = kuza_classic_blog_get_option( 'homepage_design_layout_options');
    $fitnesscat_content_type     = kuza_classic_blog_get_option( 'fitnesscat_content_type' );
    $number_of_fitnesscat_items  = kuza_classic_blog_get_option( 'number_of_fitnesscat_items' );
    for( $i=1; $i<=$number_of_fitnesscat_items; $i++ ) :
        $fitnesscat_product_category[] = absint(kuza_classic_blog_get_option( 'fitnesscat_product_category_'.$i ) );
    endfor;
    $small_category ='';
