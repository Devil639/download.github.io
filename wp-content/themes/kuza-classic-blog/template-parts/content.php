...
?>
<?php 
	$enable_category     = kuza_classic_blog_get_option( 'latest_category_enable' );
	$enable_author     = kuza_classic_blog_get_option( 'latest_author_enable' );
	$enable_comment     = kuza_classic_blog_get_option( 'latest_comment_enable' );
	$enable_read_more_text     = kuza_classic_blog_get_option( 'latest_read_more_text_enable' );
    $enable_posted_on     = kuza_classic_blog_get_option( 'latest_posted_on_enable' );
    $enable_video = kuza_classic_blog_get_option( 'latest_video_enable' );
    $header_font_size = kuza_classic_blog_get_option( 'latest_font_size');
	$latest_readmore_text = kuza_classic_blog_get_option( 'latest_readmore_text' );
	$blog_layout_content_type = kuza_classic_blog_get_option( 'blog_layout_content_type' );
	$content_align = kuza_classic_blog_get_option( 'archive_content_align' );
 ?>
...
<?php } else { ?>
	<article id="post-<?php the_ID(); ?>" <?php if ($blog_layout_content_type=='blog-one'){ post_class( 'grid-item clear' ); } else{post_class();} ?>>
		<div class="post-item">
			<?php 
				$video_url = get_post_meta( get_the_ID(), 'kuza-classic-blog-video-url', true );
