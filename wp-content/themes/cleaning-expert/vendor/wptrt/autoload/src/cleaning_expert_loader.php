...
class Cleaning_Expert_Loader {
	 ...
	 * @return void
	 */
	public function cleaning_expert_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function cleaning_expert_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function cleaning_expert_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function cleaning_expert_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->cleaning_expert_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function cleaning_expert_load( $class ) {
